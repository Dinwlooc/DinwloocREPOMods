...
namespace Dinwlooc.Common.Bridge
{
    ...
    /// </summary>
    public class GrabberOverrideBridge : IGrabberOverrideBridge
    {
        private static GrabberOverrideBridge? _instance;
        public static GrabberOverrideBridge Instance => _instance ??= new GrabberOverrideBridge();
        ...
        public void OverrideGrab(PhysGrabObject target, float grabTime = 0.1f, bool grabRelease = false)
        {
        ...
        public void OverrideBeamColor(Color color, float time = 0.1f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
        ...
        public void OverrideGrabRelease(int releaseObjectViewID, float disableTimer = 0.5f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
        ...
        public void OverrideGrabStrength(float strength, float time = 0.1f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
        ...
        public void OverrideAimTransform(Transform aimTransform, float time = 0.1f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
        ...
        public void OverrideAlwaysGrabbable(float time = 0.1f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
        ...
        public void OverrideOverchargeDisable(float disableTimer = 0.1f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
        ...
        public void OverrideDisableGrabLookAt(float time = 0.1f)
        {
            PhysGrabber? grabber = GetGrabber();
            if (grabber == null) return;
